...
import { BridgedFormValuesContainer } from '@icure/form/icure'
import { property, state } from 'lit/decorators.js'
import { makeFormValuesContainer } from './form-values-container'
import { makeInterpreter } from '@icure/form/utils/interpreter'
import MiniSearch, { SearchResult } from 'minisearch'
import { codes } from './codes'
import { Code, Field, FieldMetadata, Form, Group, Subform } from '@icure/form/components/model'
import { initializeWithFormDefaultValues } from '@icure/form/utils/form-value-container'
