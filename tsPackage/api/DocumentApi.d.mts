...
export interface DocumentApi {
    ...
    withEncryptionMetadata(base: DecryptedDocument | undefined, message: Message | undefined, options?: {
        user?: User | undefined;
        delegates?: {
    ...
    getAndTryDecryptMainAttachmentAsPlainText(document: Document, options?: {
        decryptedAttachmentValidator?: (x1: Int8Array) => Promise<boolean>;
    }): Promise<string | undefined>;
    getAndTryDecryptMainAttachmentAsJson(document: Document, options?: {
        decryptedAttachmentValidator?: (x1: Int8Array) => Promise<boolean>;
    ...
    findDocumentsByHcPartyPatient(hcPartyId: string, patient: Patient, options?: {
