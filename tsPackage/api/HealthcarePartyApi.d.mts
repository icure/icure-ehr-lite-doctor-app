...
export interface HealthcarePartyApi {
    ...
    modifyHealthcarePartyInGroup(groupId: string, healthcareParty: HealthcareParty): Promise<HealthcareParty>;
    createHealthcarePartyInGroup(groupId: string, healthcareParty: HealthcareParty): Promise<HealthcareParty>;
    getCurrentHealthcareParty(): Promise<HealthcareParty>;
    findHealthcarePartiesBy(options?: {
        startKey?: string | undefined;
        startDocumentId?: string | undefined;
        limit?: number | undefined;
        desc?: boolean | undefined;
    }): Promise<PaginatedList<HealthcareParty>>;
    findHealthcarePartiesByName(options?: {
    ...
    findHealthcarePartiesBySsinOrNihii(searchValue: string, options?: {
        startKey?: string | undefined;
        startDocumentId?: string | undefined;
        limit?: number | undefined;
        desc?: boolean;
    ...
    findHealthcarePartiesBySpecialityAndPostCode(type: string, spec: string, firstCode: string, lastCode: string, options?: {
        startKey?: string | undefined;
        startDocumentId?: string | undefined;
        limit?: number | undefined;
    }): Promise<PaginatedList<HealthcareParty>>;
    ...
    getHealthcarePartiesInGroup(groupId: string, options?: {
        healthcarePartyIds?: Array<string> | undefined;
    ...
    deleteHealthcarePartyInGroupById(groupId: string, entityId: string, rev: string): Promise<DocIdentifier>;
    deleteHealthcarePartiesInGroupByIds(groupId: string, entityIds: Array<IdWithMandatoryRev>): Promise<Array<DocIdentifier>>;
    ...
    deleteHealthcarePartiesInGroup(groupId: string, healthcareParties: Array<HealthcareParty>): Promise<Array<DocIdentifier>>;
