...
export interface GroupApi {
    ...
    createGroup(id: string, name: string, password: string, initialisationData: DatabaseInitialisation, options?: {
    ...
    findGroupsWithContent(id: string, searchString: string, options?: {
    ...
    getOperationToken(operation: Operation, duration: number | undefined, options?: {
    ...
    getDefaultRoles(groupId: string): Promise<{
        [key in UserType]?: Array<RoleConfiguration>;
    }>;
    ...
    initDesignDocs(id: string, warmup: boolean | undefined, dryRun: boolean | undefined, options?: {
        clazz?: string | undefined;
    }): Promise<Array<DesignDocument>>;
    solveConflicts(id: string, limit: number | undefined, warmup: boolean | undefined): Promise<Array<IdWithRev>>;
    resetStorage(id: string, databases: Array<string>, options?: {
        q?: number | undefined;
        n?: number | undefined;
    }): Promise<void>;
