...
export interface ContactBasicApi {
    ...
    listContactByHCPartyServiceId(hcPartyId: string, serviceId: string): Promise<Array<EncryptedContact>>;
    listContactsByExternalId(externalId: string): Promise<Array<EncryptedContact>>;
    listContactsByHCPartyAndFormId(hcPartyId: string, formId: string): Promise<Array<EncryptedContact>>;
    listContactsByHCPartyAndFormIds(hcPartyId: string, formIds: Array<string>): Promise<Array<EncryptedContact>>;
    ...
    listServicesByHealthElementId(hcPartyId: string, healthElementId: string): Promise<Array<EncryptedService>>;
