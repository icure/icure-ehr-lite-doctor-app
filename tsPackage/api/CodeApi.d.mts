...
export interface CodeApi {
    findCodesByLabel(region: string | undefined, types: string, language: string, label: string, options?: {
        version?: string | undefined;
        startKey?: any | undefined;
        startDocumentId?: string | undefined;
        limit?: number | undefined;
    }): Promise<PaginatedList<Code>>;
    findCodesByType(region: string, options?: {
    ...
    findCodesByLink(linkType: string, options?: {
        linkedId?: string | undefined;
        startKey?: any | undefined;
        startDocumentId?: string | undefined;
        limit?: number | undefined;
    }): Promise<PaginatedList<Code>>;
    listCodesByRegionTypeCodeVersion(region: string, options?: {
        type?: string | undefined;
        code?: string | undefined;
        version?: string | undefined;
    }): Promise<Array<Code>>;
    listCodeTypesBy(options?: {
        region?: string | undefined;
        type?: string | undefined;
    }): Promise<Array<string>>;
    listTagTypesBy(options?: {
        region?: string | undefined;
        type?: string | undefined;
    }): Promise<Array<string>>;
    ...
    getCodeByRegionLanguageTypeLabel(region: string, label: string, type: string, languages: string | undefined): Promise<Code | undefined>;
