...
export interface InvoiceApi {
    ...
    removeCodes(userId: string, serviceId: string, secretFKeys: string, tarificationIds: Array<string>): Promise<Array<DecryptedInvoice>>;
    ...
    listInvoicesByHcPartyAndGroupId(hcPartyId: string, groupId: string): Promise<Array<DecryptedInvoice>>;
    ...
    listInvoicesByHcpartySendingModeStatusDate(hcPartyId: string, sendingMode: string, status: string, from: number, to: number): Promise<Array<DecryptedInvoice>>;
