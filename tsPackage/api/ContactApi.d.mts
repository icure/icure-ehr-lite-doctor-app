...
export interface ContactApi {
    ...
    findContactsByHcPartyPatient(hcPartyId: string, patient: Patient, options?: {
    ...
    listContactByHCPartyServiceId(hcPartyId: string, serviceId: string): Promise<Array<DecryptedContact>>;
    listContactsByExternalId(externalId: string): Promise<Array<DecryptedContact>>;
    listContactsByHCPartyAndFormId(hcPartyId: string, formId: string): Promise<Array<DecryptedContact>>;
    listContactsByHCPartyAndFormIds(hcPartyId: string, formIds: Array<string>): Promise<Array<DecryptedContact>>;
    ...
    listServicesByHealthElementId(hcPartyId: string, healthElementId: string): Promise<Array<DecryptedService>>;
    findContactsByOpeningDate(startDate: number, endDate: number, hcPartyId: string, options?: {
