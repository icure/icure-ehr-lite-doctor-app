...
export interface InvoiceBasicApi {
    ...
    removeCodes(userId: string, serviceId: string, secretFKeys: string, tarificationIds: Array<string>): Promise<Array<EncryptedInvoice>>;
    ...
    listInvoicesByHcPartyAndGroupId(hcPartyId: string, groupId: string): Promise<Array<EncryptedInvoice>>;
    ...
    listInvoicesByHcpartySendingModeStatusDate(hcPartyId: string, sendingMode: string, status: string, from: number, to: number): Promise<Array<EncryptedInvoice>>;
