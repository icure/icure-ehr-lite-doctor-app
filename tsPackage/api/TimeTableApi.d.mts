...
export interface TimeTableApi {
    ...
    withEncryptionMetadata(base: DecryptedTimeTable | undefined, patient: Patient | undefined, options?: {
        user?: User | undefined;
        delegates?: {
    ...
    createDelegationDeAnonymizationMetadata(entity: TimeTable, delegates: Array<string>): Promise<void>;
    ...
    shareWith(delegateId: string, timeTable: DecryptedTimeTable, options?: {
        options?: TimeTableShareOptions | undefined;
    }): Promise<DecryptedTimeTable>;
    shareWithMany(timeTable: DecryptedTimeTable, delegates: {
    ...
    getTimeTablesByPeriodAndAgendaId(startDate: number, endDate: number, agendaId: string): Promise<Array<DecryptedTimeTable>>;
