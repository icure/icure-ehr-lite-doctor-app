...
export interface FormApi {
    ...
    withEncryptionMetadata(base: DecryptedForm | undefined, patient: Patient, options?: {
        user?: User | undefined;
        delegates?: {
    ...
    getFormTemplate(formTemplateId: string, options?: {
        raw?: boolean | undefined;
    }): Promise<FormTemplate>;
    getFormTemplatesByGuid(formTemplateGuid: string, specialityCode: string, raw: boolean | undefined): Promise<Array<FormTemplate>>;
    listFormTemplatesBySpeciality(specialityCode: string, options?: {
        raw?: boolean | undefined;
    }): Promise<Array<FormTemplate>>;
    getFormTemplates(options?: {
        loadLayout?: boolean | undefined;
        raw?: boolean | undefined;
    }): Promise<Array<FormTemplate>>;
    ...
    shareWithMany(form: DecryptedForm, delegates: {
