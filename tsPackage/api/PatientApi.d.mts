...
export interface PatientApi {
    ...
    findPatientsByNameBirthSsinAuto(filterValue: string, options?: {
    ...
    listPatientsOfHcParty(hcPartyId: string, options?: {
        sortField?: string;
        startKey?: string | undefined;
        startDocumentId?: string | undefined;
        limit?: number | undefined;
    ...
    findPatientsModifiedAfter(date: number, options?: {
        startKey?: number | undefined;
        startDocumentId?: string | undefined;
        limit?: number | undefined;
    }): Promise<PaginatedList<DecryptedPatient>>;
    listPatientsByHcParty(hcPartyId: string, options?: {
        sortField?: string;
        startKey?: string | undefined;
        startDocumentId?: string | undefined;
        limit?: number | undefined;
    ...
    findPatientsByHealthcareParty(options?: {
    ...
    findPatientsIdsByHealthcareParty(hcPartyId: string, options?: {
        startKey?: string | undefined;
        startDocumentId?: string | undefined;
        limit?: number | undefined;
    }): Promise<PaginatedList<string>>;
    getPatientByExternalId(externalId: string): Promise<DecryptedPatient>;
    fuzzySearch(firstName: string, lastName: string, options?: {
        dateOfBirth?: number | undefined;
    }): Promise<Array<DecryptedPatient>>;
    findDeletedPatients(startDate: number, options?: {
    ...
    listDeletedPatientsByName(options?: {
        firstName?: string | undefined;
        lastName?: string | undefined;
    }): Promise<Array<DecryptedPatient>>;
    getPatients(patientIds: Array<string>): Promise<Array<DecryptedPatient>>;
    getPatientByHealthcarePartyAndIdentifier(hcPartyId: string, id: string, options?: {
        system?: string | undefined;
    }): Promise<DecryptedPatient>;
    modifyPatients(patientDtos: Array<EncryptedPatient>): Promise<Array<IdWithRev>>;
    findDuplicatesBySsin(hcPartyId: string, options?: {
        startKey?: string | undefined;
        startDocumentId?: string | undefined;
        limit?: number | undefined;
    }): Promise<PaginatedList<DecryptedPatient>>;
    findDuplicatesByName(hcPartyId: string, options?: {
        startKey?: string | undefined;
        startDocumentId?: string | undefined;
        limit?: number | undefined;
    }): Promise<PaginatedList<DecryptedPatient>>;
